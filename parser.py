...
options = Options()
# 00options.add_argument('--headless')
...
while not choosen_departments:
    ...
    if choosen_department >= 0 and choosen_department <= 1:
...
for course in courses:
    ...
    for video_page_url in videos_pages_urls:
        try:
            ...
            print(f"Problemi nel download del video all'url '{video_page_url}'. Passo al successivo")
